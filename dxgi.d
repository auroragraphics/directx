...
enum DXGI_GRAPHICS_PREEMPTION_GRANULARITY : int { 
...
enum DXGI_COMPUTE_PREEMPTION_GRANULARITY : int { 
	DMA_BUFFER_BOUNDARY    = 0,
	DISPATCH_BOUNDARY      = 1,
...
enum DXGI_RESIDENCY : int { 
	FULLY_RESIDENT             = 1,
	RESIDENT_IN_SHARED_MEMORY  = 2,
	EVICTED_TO_DISK            = 3
}

enum DXGI_OFFER_RESOURCE_PRIORITY : int { 
	PRIORITY_LOW     = 1,
...
enum DXGI_SCALING : int { 
	STRETCH               = 0,
	NONE                  = 1,
	ASPECT_RATIO_STRETCH  = 2
}

enum DXGI_ALPHA_MODE : int { 
	UNSPECIFIED    = 0,
	PREMULTIPLIED  = 1,
	STRAIGHT       = 2,
	IGNORE         = 3,
